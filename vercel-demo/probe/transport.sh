...
#
# Transport-reachability probes for Vercel platform hosts — the dashboard, REST
# API, marketing site, the deployed site edge, and DNS resolution.
#
...
echo "Transport reachability (Vercel platform hosts)"
echo "----------------------------------------------"

host_probe "www"       "Marketing site"       "Dashboard"        "https://vercel.com/"
host_probe "api"       "REST API"             "Vercel API"       "https://api.vercel.com/"
host_probe "vitals"    "Analytics infra"      "Analytics"        "https://vitals.vercel-insights.com/"

dns_probe "dns-vercel" "DNS vercel.app"       "DNS"              "vercel.app"

if [ -n "${VERCEL_SITE_URL:-}" ]; then
